...
public record MusicaRequestDto(@NotBlank(message = "O título não pode ser vazio!") String title,
                               ...
                               @NotNull(message = "Duração não deve ser nula!") @Positive (message = "Duração deve ser maior que zero") int duration,
                               @NotNull(message = "A playlist deve informar qual o seu banco!") Playlist playlist) {
}
